...
(test 'euclid
      ...
      (euclid #
              65537))

(: keygen (Natural Natural -> key-pair))
(define (keygen n phi)
  (let ([e (generate-prime (+ 65537 (random 65538)))])
    (key-pair (key e n) (key (euclid n e) n))))
